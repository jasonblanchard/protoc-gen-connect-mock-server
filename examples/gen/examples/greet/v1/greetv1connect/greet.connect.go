...
const (
	...
	StatusServiceName = "greet.v1.StatusService"
)
...
const (
	...
	StatusServiceStatusProcedure = "/greet.v1.StatusService/Status"
)
...
// StatusServiceClient is a client for the greet.v1.StatusService service.
type StatusServiceClient interface {
	Status(context.Context, *connect_go.Request[v1.StatusRequest]) (*connect_go.Response[v1.StatusResponse], error)
}

// NewStatusServiceClient constructs a client for the greet.v1.StatusService service. By default, it
// uses the Connect protocol with the binary Protobuf Codec, asks for gzipped responses, and sends
// uncompressed requests. To use the gRPC or gRPC-Web protocols, supply the connect.WithGRPC() or
// connect.WithGRPCWeb() options.
//
...
// Status calls greet.v1.StatusService.Status.
...
// StatusServiceHandler is an implementation of the greet.v1.StatusService service.
...
func NewStatusServiceHandler(svc StatusServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/greet.v1.StatusService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedStatusServiceHandler) Status(context.Context, *connect_go.Request[v1.StatusRequest]) (*connect_go.Response[v1.StatusResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("greet.v1.StatusService.Status is not implemented"))
}
